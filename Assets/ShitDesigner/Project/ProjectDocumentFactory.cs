...
namespace ShitDesigner.Project
{
    ...
    public static class ProjectDocumentFactory
    {
        ...
        /// </summary>
        public static Result<ProjectDocument> CreateNew(string projectName, IProjectIdFactory idFactory = null)
        {
        ...
        public static Result<ProjectDocument> TryCreate(
            string projectName,
            ...
            IProjectIdFactory idFactory = null)
        {
            ...
            return detailed.IsFailure
                ? Result<ProjectDocument>.Failure(detailed.Diagnostic)
                : Result<ProjectDocument>.Success(detailed.Value.Document);
        }

        public static Result<ProjectDocumentFactoryResult> TryCreateDetailed(
            string projectName,
            int projectFormatVersion,
            IEnumerable<NodeRecord> nodes,
            IEnumerable<ConnectionRecord> connections,
            ...
            IProjectIdFactory idFactory = null)
        {
            ...
            if (identity.IsFailure) return Result<ProjectDocumentFactoryResult>.Failure(identity.Diagnostic);
            ...
            return Result<ProjectDocumentFactoryResult>.Success(new ProjectDocumentFactoryResult(candidate, repairInfo));
        }
        ...
        /// </summary>
        public static Result<ProjectDocument> Rehydrate(
        ...
        private static Result ValidateIdentity(IEnumerable<NodeRecord> nodes, IEnumerable<ConnectionRecord> connections, IEnumerable<LogicalControlRecord> controls, IEnumerable<ParameterExpressionRecord> expressions, IEnumerable<PresetRecord> presets, IEnumerable<MediaAssetRecord> assets)
        {
        ...
        private static Result<T> Failure<T>(string code, string message) => Result<T>.Failure(new Diagnostic(new DiagnosticCode(code), Severity.Error, message));
