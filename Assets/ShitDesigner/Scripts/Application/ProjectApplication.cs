...
namespace ShitDesigner.Application
{
    ...
    public sealed class ProjectApplication : IProjectApplicationReadPort, IProjectApplicationCommandPort, IApplicationCommandPort, IKeyboardInputApplicationPort, IMidiInputApplicationPort, ILiveControlApplicationPort, IApplicationShortcutCommandPort, IDisposable
    {
        ...
        private sealed class CommandLedgerEntry
        {
            ...
            internal CommandLedgerEntry(Guid requestId, Guid interactionId, Guid sessionId, long revision, CommandQueueKind kind)
            { RequestId = requestId; InteractionId = interactionId; SessionId = sessionId; Revision = revision; Kind = kind; }
        }
        ...
        private sealed class MediaImportBatchOperation
        {
            ...
            internal MediaImportBatchOperation(Guid requestId, Guid sessionId, IReadOnlyList<ApplicationMediaImportRequest> requests)
            { RequestId = requestId; SessionId = sessionId; Requests = requests; }
        }
