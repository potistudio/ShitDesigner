...
namespace ShitDesigner.Bootstrap
{
    ...
    internal sealed class WindowsNativeFileDialogBackend : IProductionPlatformFileDialogBackend
    {
        ...
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)] private struct BrowseInfo
        { public IntPtr Owner; public IntPtr Root; public StringBuilder DisplayName; [MarshalAs(UnmanagedType.LPWStr)] public string Title; public BrowseFlags Flags; public IntPtr Callback; public IntPtr Param; public int Image; }
