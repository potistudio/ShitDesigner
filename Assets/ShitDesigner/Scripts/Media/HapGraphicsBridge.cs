...
namespace ShitDesigner.Media {
	...
	internal readonly struct HapNativeFrameView {
		...
		public HapNativeFrameView(uint width, uint height, bool isYCoCg, int planeCount, HapNativePlaneView plane0, HapNativePlaneView plane1) { Width = width; Height = height; IsYCoCg = isYCoCg; PlaneCount = planeCount; Plane0 = plane0; Plane1 = plane1; }
