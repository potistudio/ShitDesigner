...
namespace ShitDesigner.Presentation {
	...
	public readonly struct ShortcutBinding {
		...
		public ShortcutBinding(PresentationKey key, string commandId, bool primary = false, bool shift = false, bool alt = false) { Key = key; CommandId = commandId ?? string.Empty; Primary = primary; Shift = shift; Alt = alt; }
	}
