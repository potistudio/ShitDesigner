...
namespace ShitDesigner.Presentation {
	...
	public sealed class WorkspaceSettingsCommand {
		...
		public WorkspaceSettingsCommand(string operation, string layoutId = null, string name = null, string newLayoutId = null,
			...
			string theme = null, float? tooltipDelaySeconds = null, string mediaLibraryView = null, string diagnosticsExportFolder = null, string recentProjectRoot = null) { Operation = operation ?? string.Empty; LayoutId = layoutId ?? string.Empty; Name = name ?? string.Empty; NewLayoutId = newLayoutId ?? string.Empty; Tree = tree; UiScale = uiScale; ReduceMotion = reduceMotion; IsDirty = isDirty; Theme = theme; TooltipDelaySeconds = tooltipDelaySeconds; MediaLibraryView = mediaLibraryView; DiagnosticsExportFolder = diagnosticsExportFolder; RecentProjectRoot = recentProjectRoot; }
	}
	...
	public sealed class WorkspaceSettingsCommandResult {
		...
		public WorkspaceSettingsCommandResult(bool isSuccess, WorkspaceSettingsSnapshot snapshot, string error = null) { IsSuccess = isSuccess; Snapshot = snapshot; Error = error ?? string.Empty; }
	}
