...
namespace ShitDesigner.Presentation
{
    ...
    public sealed class PreviewTabState
    {
        ...
        public PreviewTabState(string nodeId, string tabId, PresentationOutputFit fit, PresentationOutputBackground background, bool isVisible)
        { NodeId = nodeId ?? string.Empty; TabId = tabId ?? string.Empty; Fit = fit; Background = background; IsVisible = isVisible; }
    }
