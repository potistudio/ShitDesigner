...
namespace ShitDesigner.Presentation
{
    ...
    public sealed class NodeCatalogItem
    {
        ...
        public NodeCatalogItem(string typeId, string displayName, bool isAvailable = true, string disabledReason = null, bool userAddable = true,
            string category = null, bool isFavorite = false, bool isRecent = false)
        { TypeId = typeId ?? string.Empty; DisplayName = displayName ?? typeId ?? string.Empty; Category = category ?? string.Empty; IsAvailable = isAvailable; UserAddable = userAddable; IsFavorite = isFavorite; IsRecent = isRecent; DisabledReason = disabledReason ?? string.Empty; }
    }
    ...
    public sealed class LogicalControlReadModel
    {
        ...
        public LogicalControlReadModel(string id, string name, string kind, string presetId = null, bool isBroken = false, float? currentValue = null, bool isFiring = false)
        { Id = id ?? string.Empty; Name = name ?? id ?? string.Empty; Kind = kind ?? string.Empty; PresetId = presetId ?? string.Empty; IsBroken = isBroken; CurrentValue = currentValue; IsFiring = isFiring; }
    }
    ...
    public sealed class ParameterComponentRangeReadModel
    {
        ...
        public ParameterComponentRangeReadModel(string name, string minimum, string maximum)
    ...
    public sealed class ParameterOptionReadModel
    {
        public string Id { get; }
        public string DisplayName { get; }
        public ParameterOptionReadModel(string id, string displayName)
    ...
    public sealed class PresentationTaskReadModel
    {
        ...
        public string Error { get; }
        public PresentationTaskReadModel(Guid taskId, string kind, string stage, string status, int completedItems = 0, int totalItems = 0, string currentItem = null, string error = null)
        { TaskId = taskId; Kind = kind ?? string.Empty; Stage = stage ?? string.Empty; Status = status ?? string.Empty; CompletedItems = completedItems; TotalItems = totalItems; CurrentItem = currentItem ?? string.Empty; Error = error ?? string.Empty; }
    }
