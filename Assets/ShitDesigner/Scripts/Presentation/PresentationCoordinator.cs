...
namespace ShitDesigner.Presentation
{
    public sealed class PresentationApplyReport
    {
        ...
        public PresentationApplyReport(bool applied, bool requestedFullSnapshot, Guid projectSessionId, long readModelVersion)
        { Applied = applied; RequestedFullSnapshot = requestedFullSnapshot; ProjectSessionId = projectSessionId; ReadModelVersion = readModelVersion; }
    }
