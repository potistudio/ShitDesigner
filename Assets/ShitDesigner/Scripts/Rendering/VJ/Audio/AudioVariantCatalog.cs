namespace ShitDesigner.Rendering.VJ.Audio {
	public static class AudioVariantCatalog {
		public static readonly string[] Names =
		{
			"waveform_line", "waveform_fill", "dual_waveform", "xy_lissajous_scope", "vectorscope",
			"radial_waveform", "circular_oscilloscope", "spectrum_bars", "mirrored_spectrum", "radial_spectrum",
