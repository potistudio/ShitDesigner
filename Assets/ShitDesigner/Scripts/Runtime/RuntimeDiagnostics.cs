...
namespace ShitDesigner.Runtime
{
    public sealed class DiagnosticHistoryEntry
    {
        ...
        internal DiagnosticHistoryEntry(ulong entryId, Diagnostic diagnostic, long count, ulong firstFrame, ulong lastFrame)
        { EntryId = entryId; Diagnostic = diagnostic; Count = count; FirstFrame = firstFrame; LastFrame = lastFrame; }
    }
